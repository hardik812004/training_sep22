...
a='wertyuiop'
b="wetiopasjkl"
c=''' qwertyuiopasdfghjkzxcvbnm
asdfghjkzxcvbnmasdfghjkqweuiop
asfgergfsdsgffgfdffssfd
'''
c
...
=============== RESTART: C:/Users/SSPO/AppData/Local/Programs/Python/Python310/sc.py ==============
hey\
...
SyntaxError: invalid syntax'Hello World!Hello World!Hello World!Hello World!Hello World!Hello World!Hello World!Hello World!SyntaxError: invalid syntax
SyntaxError: unterminated string literal (detected at line 1)
...
'Hello world'
a.title
<built-in method title of str object at 0x000000434B0CC1F0>
a.title()
'Hello World'
a.center
<built-in method center of str object at 0x000000434B0CC1F0>
a.center()
Traceback (most recent call last):
...
b='a'
b.center
<built-in method center of str object at 0x0000004348DC5A70>
9
b.center(1)
'a'
b.center(2)
...
m+=['new val','er']
m
[12, 'hi', 2.3, 500, 'new val', 'abc', 'new val', 'er']
m=[12, 'hi', 2.3, 500, 'new val', 'abc']
m
[12, 'hi', 2.3, 500, 'new val', 'abc']
...
m
[12, 'hi', 'hello', 2.3, 500, 'new val', 'abc', 'x', 'y', ['abc', 'ab']]
m=[12, 'hi', 'hello', 2.3, 500, 'new val', 'abc', 'x', 'y']
m
[12, 'hi', 'hello', 2.3, 500, 'new val', 'abc', 'x', 'y']
m=[12, 'hi', 'hello', 2.3, 500, 'new val', 'abc', 'x', 'y', ['abc', 'ab']]
m.pop()
['abc', 'ab']
m
[12, 'hi', 'hello', 2.3, 500, 'new val', 'abc', 'x', 'y']
...
Traceback (most recent call last):
  File "<pyshell#293>", line 1, in <module>
    s.ntersection(s2)
AttributeError: 'set' object has no attribute 'ntersection'. Did you mean: 'intersection'?
s2={23,3,41,4}
s.intersection(s2)
{3, 4}
s.union(s2)
