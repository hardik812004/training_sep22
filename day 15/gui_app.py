...
# ttk.Button(app,text = 'Isko Click Kardo',command=abc,font=("Arial",20)).place(x=100,y=100)
# # ttk.Button(app,text="Yeh wala bhi hai",command=lambda:print("Wow")).place(x=100,y=130)
# ttk.Button(app,text="Yeh wala bhi hai",command=lambda:msg.set("Pata Nahi"),font=("Arial",20)).place(x=150,y=200)
